...
import com.kingnet.startup.Initializer.BInitializer;
 ...
 * Description:
 */
public class DAndroidStartUp extends AndroidStartup<Object> {
    @Nullable
    @Override
    ...
    public List<String> dependenciesByName() {
        ...
        list.add(BAndroidStartUp.class.getCanonicalName());
        return list;
    }
